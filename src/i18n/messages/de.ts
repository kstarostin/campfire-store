...
export const de: Messages = {
  ...
  toast: {
    ...
    addressDeleted: 'Adresse entfernt',
  },
  documentTitle: {
    home: 'Startseite',
    category: '{name}',
  ...
  footer: {
    ...
    contactBlurb:
      'Fragen zu Ausrüstung, Größen oder einer Bestellung? Schreib uns und wir melden uns.',
    name: 'Dein Name',
    email: 'E-Mail-Adresse',
    message: 'Wie können wir helfen?',
    send: 'Nachricht senden',
    newsletterTitle: 'Bleib auf dem Laufenden',
    newsletterBlurb: 'Neuheiten, Field Notes und saisonale Tipps. Ohne Spam.',
    newsletterEmail: 'Deine E-Mail',
    ...
    createdBy: 'Erstellt von Konstantin Starostin',
  },
  search: {
    title: 'Suche',
    titleWithQuery: 'Suche: „{query}"',
    resultsFor: 'Suchergebnisse für',
    emptyTitle: 'Store durchsuchen',
    emptyBody:
      'Finde Ausrüstung, Marken und Kategorien über das Suchfeld in der Kopfzeile.',
    emptyHint:
  ...
  catalog: {
    ...
    filtersEmptyTitle: 'Keine Treffer für diese Filter',
    filtersEmptyBody:
      'Keine Produkte entsprechen diesen Filtern. Wähle eine andere Marke oder passe den Preisbereich an.',
    searchNoResultsTitle: 'Keine Ergebnisse für „{query}"',
    searchNoResultsBody:
      'Probiere andere Suchbegriffe, weniger Wörter oder stöbere in den Kategorien.',
    categoryEmptyTitle: 'Hier gibt es noch keine Produkte',
    categoryEmptyBody:
      'Diese Kategorie ist noch leer. Entdecke den gesamten Katalog oder eine andere Abteilung.',
    browseAllProducts: 'Alle Produkte anzeigen',
  ...
  account: {
    ...
    ordersDescription: 'Deine Bestellhistorie — wähle eine Bestellung für Details.',
    orders: {
      listLabel: 'Bestellungen',
      showing: '{start}–{end} von {total} Bestellungen',
      ...
      emptyBody: 'Sobald du eine Bestellung aufgibst, erscheint sie hier.',
      browseProducts: 'Produkte entdecken',
      loadError: 'Bestellungen konnten nicht geladen werden.',
      detailError: 'Diese Bestellung konnte nicht geladen werden.',
      status: {
        open: 'Offen',
  ...
  checkout: {
    ...
    successNextSteps: 'Wie es weitergeht',
    successStepEmail: 'Prüfe deine E-Mail für Bestätigung und Beleg.',
    successStepTrack: 'Status und Details findest du jederzeit in deinem Konto.',
    successShareHint: 'Bestelllink speichern oder teilen',
    copyOrderLink: 'Bestelllink kopieren',
  ...
  pages: {
    ...
    account: 'Konto',
    accountHint: 'Verwalte Profil, Adressen, Bestellungen und Wunschliste.',
    cart: 'Warenkorb',
    cartHint: 'Artikel prüfen und zur Kasse gehen.',
    checkout: 'Kasse',
    checkoutHint: 'Wähle eine Lieferadresse und schließe deine Bestellung ab.',
    orders: 'Bestellungen',
    ordersHint: 'Sieh deine Bestellhistorie und Details ein.',
    orderDetail: 'Bestelldetails',
    orderDetailHint: 'Bestelldetails und Artikel.',
    wishlist: 'Wunschliste',
