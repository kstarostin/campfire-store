export const en = {
  ...
  footer: {
    ...
    contactBlurb:
      'Questions about gear, sizing or an order? Send us a note and we will get back to you.',
    name: 'Your name',
    email: 'Email address',
    message: 'How can we help?',
    send: 'Send message',
    newsletterTitle: 'Stay up to date',
    newsletterBlurb: 'New arrivals, field notes and seasonal picks. No noise.',
    ...
    createdBy: 'Created by Konstantin Starostin',
  },
  search: {
    title: 'Search',
  ...
  catalog: {
    ...
    searchNoResultsTitle: 'No results for “{query}”',
    searchNoResultsBody:
      'Try different keywords, fewer words, or browse categories instead.',
    categoryEmptyTitle: 'No products here yet',
    categoryEmptyBody:
      'This category is empty for now. Browse the full catalog or try another aisle.',
  ...
  checkout: {
    ...
    successStepEmail: 'Check your email for order confirmation and receipt.',
    successStepTrack: 'Track status and details anytime in your account.',
    successShareHint: 'Save or share this order link',
  ...
  pages: {
    ...
    account: 'Account',
    accountHint: 'Manage your profile, addresses, orders, and wishlist.',
    cart: 'Shopping cart',
    cartHint: 'Review items and proceed to checkout.',
    checkout: 'Checkout',
    checkoutHint: 'Choose a delivery address and place your order.',
    orders: 'Orders',
    ordersHint: 'View your order history and details.',
    orderDetail: 'Order detail',
    orderDetailHint: 'Order details and line items.',
    wishlist: 'Wishlist',
